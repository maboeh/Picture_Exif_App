...
class Gui:
        ...
        def create_widgets(self):
                ...
                self.sourceCheck = ttk.Checkbutton(self.root, text="Include Subfolders", variable=self.sourceCheck_var, onvalue=True, offvalue=False)
                self.sourceCheck.grid(row=2, column=2, sticky="w", padx=10, pady=10)
                ...
                self.targetCheck = ttk.Checkbutton(self.root, text="Generate CSV-file", variable=self.targetCheck_var, onvalue=True, offvalue=False)
                self.targetCheck.grid(row=7, column=2, sticky="w", padx=10, pady=10)
